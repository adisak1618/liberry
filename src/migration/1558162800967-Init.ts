...
export class Init1558162800967 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "book" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "page_count" integer NOT NULL, "publisher" character varying NOT NULL, "price" integer NOT NULL, "isbnCode" character varying NOT NULL, "count" integer NOT NULL, "remain" integer NOT NULL, "cover" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "version" integer NOT NULL, "categoryId" uuid, "writerId" uuid, CONSTRAINT "PK_a3afef72ec8f80e6e5c310b28a4" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userCode" character varying NOT NULL, "nickname" character varying, "fullname" character varying NOT NULL, "userClass" character varying NOT NULL, "age" integer NOT NULL, "tel" character varying NOT NULL, "profilePicture" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "version" integer NOT NULL, CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
