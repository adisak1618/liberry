...
export class init1565257176173 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "book" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "page_count" integer NOT NULL, "publisher" character varying NOT NULL, "price" integer NOT NULL, "isbnCode" character varying NOT NULL, "count" integer NOT NULL, "remain" integer NOT NULL, "cover" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "version" integer NOT NULL, "categoryId" uuid, "writerId" uuid, CONSTRAINT "UQ_b27df7eaebd40ea42b7edd240a5" UNIQUE ("isbnCode"), CONSTRAINT "PK_a3afef72ec8f80e6e5c310b28a4" PRIMARY KEY ("id"))`);
